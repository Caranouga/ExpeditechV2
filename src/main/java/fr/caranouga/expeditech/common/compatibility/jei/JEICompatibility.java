...
import fr.caranouga.expeditech.common.compatibility.jei.coal_generator.CoalGeneratorFuelRecipe;
import fr.caranouga.expeditech.common.compatibility.jei.coal_generator.CoalGeneratorRecipeCategory;
...
public class JEICompatibility implements IModPlugin {
    ...
    public void registerRecipeTransferHandlers(@Nonnull IRecipeTransferRegistration registration) {
        ...
        addRecipeTransferHandler(registration, CoalGeneratorRecipeCategory.UID, CoalGeneratorMachineContainer.class, 0, 1);
    }
