...
public abstract class AbstractMultiBlockMasterTile extends BaseTE implements ITickableTileEntity {
    ...
    protected void readSaveLoadTag(CompoundNBT tag) {
        if(tag.contains("savedPos")) {
            ListNBT list = tag.getList("savedPos", 10);
